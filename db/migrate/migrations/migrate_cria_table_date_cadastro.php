...
class Migrate_cria_table_date_cadastro {
    public $conn;
    ...
    public function cria_table() {
        ...
        $sql_table = "CREATE TABLE $table_name (
            ...
            hora_solicitado_id TIME NULL DEFAULT NULL,
            email_cliente VARCHAR(100),
            endereco VARCHAR(70),
            numero_casa int,
            valor_total VARCHAR(40),
            valor_entrada VARCHAR(40),
            aprovado int,
            aceite_termos TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
            cep varchar(20),
...
$cria_migrete = new Migrate_cria_table_date_cadastro();
